...
public class TopTest extends ResourceTest {
    ...
    public void testTop() throws Exception {
        assertThat("Basic karma resource path should return the correct Karma object",
                client().resource("/top/1").get(new GenericType<List<Karma>>(){}), equalTo(Arrays.asList(karma)));
    }

    @Override
    protected void setUpResources() throws Exception {
        when(mockDao.top(anyInt())).thenReturn(ImmutableList.of(karma));
        addResource(new Top(mockDao));
    }
}
